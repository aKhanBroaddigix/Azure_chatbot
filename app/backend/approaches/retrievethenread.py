...
class RetrieveThenReadApproach(Approach):
  ...
  # Example few-shot conversation
    question = """
'What are the gym hours during weekends?'

Sources:
info1.txt: The gym is open from 8 AM to 8 PM on weekends.
info2.pdf: Our gym operates from 6 AM to 10 PM on weekdays and from 8 AM to 8 PM on weekends.
"""
    answer = "The gym is open from 8 AM to 8 PM on weekends [info1.txt][info2.pdf]."
